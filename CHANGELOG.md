...
- **Layout**
  - Reduced the margin and padding on every question option and checkbox item, in both the step-by-step wizard and the single checklist view, so more of a long list (such as the services question) fits on screen at once.
